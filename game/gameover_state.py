...
def draw():
    ...
    font.draw(get_canvas_width()//2 - 300, get_canvas_height()//2 - 200, 'Coin :  %3.0f' % server.coin, (255, 255, 0))
    font.draw(get_canvas_width()//2 - 300, get_canvas_height()//2 - 300, 'Score : %3.0f' % server.score, (255, 255, 255))
