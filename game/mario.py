...
class IdleState:
    ...
    def draw(boy):
        if boy.dir == 1:
            boy.image.clip_draw(boy.frame * 100, 0, 20, 20, boy.x, boy.y)
        else:
            boy.image.clip_draw(boy.frame * 100, 0, 20, 20, boy.x, boy.y)
...
class RunState:
    ...
    def draw(boy):
        if boy.velocity == 1:
            boy.image.clip_draw(boy.frame * 202, 85, 30, 35, boy.x, boy.y,60,70)
        else:
            boy.image.clip_draw(boy.frame * 202, 0, 30, 35, boy.x, boy.y,60,70)
